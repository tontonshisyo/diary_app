...
・迷いや頭の中で考えていたこと
抽象的な質問ではなく、
できるだけ具体的な記憶を思い出せる問いにしてください。
「どう感じましたか？」のような一般的な聞き方は避け、
その場面が目に浮かぶような問いにしてください。
それぞれの質問は具体的で、今日の出来事に沿って4問程度作成してください。
"""
            response = client.chat.completions.create(
                model="gpt-3.5-turbo",
                messages=[{"role": "user", "content": prompt}],
